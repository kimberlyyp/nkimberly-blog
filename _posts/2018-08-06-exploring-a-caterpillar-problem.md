...
Typically, I like to solve a simple example by hand just to get a general idea of the problem. Thinking through this, I came up with two approaches. I'll describe the logic first, then delve into the implementation, and end with a performance comparison.
